...
<div class="siteMainOverlay"></div>
<div class="mainMobileMenuParent">
	<?php wp_nav_menu(
			array(
				'theme_location' => 'menu-1',
				'container_class'=>'mobMenu'
			)
		);
	?>
</div>
		...
		<div class="mainHeader flexBoxParent mainView">
			<div class="mobMenuParent">
				<span class="mobileMenuIcon generalBoxBorder lowRadius">
					<svg width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="icon glyph"><path d="M21 19H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2Zm0-6H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2Zm0-6H3a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2Z"/></svg>
				</span>
				<span class="mobSearchParent"><?php echo do_shortcode('[fibosearch]'); ?></span>
			</div>
